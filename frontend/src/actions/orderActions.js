...
export const createOrder = (order) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.post('https://food-bank.vercel.app/api/orders/', order, config);
...
export const getOrderDetails = (orderID) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(`https://food-bank.vercel.app/api/orders/${orderID}`, config);
	...
	(orderID, paymentResult) => async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.put(
				`https://food-bank.vercel.app/api/orders/${orderID}/pay`,
				paymentResult,
				config
			);
...
export const deliverOrder = (orderID) => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.put(
			`https://food-bank.vercel.app/api/orders/${orderID}/deliver`,
			{},
			config
		);
...
export const listMyOrders = () => async (dispatch, getState) => {
	try {
		...
		const { data } = await axios.get(`https://food-bank.vercel.app/api/orders/myorders`, config);
	...
	async (dispatch, getState) => {
		try {
			...
			const { data } = await axios.get(
				`https://food-bank.vercel.app/api/orders?pageNumber=${pageNumber}`,
				config
			);
